...
var i_13687 = (0);
while(true){
if((i_13687 < arr.length)){
(arr[i_13687] = null);

var G__13689 = (i_13687 + (1));
i_13687 = G__13689;
continue;
} else {
}
...
var i_13699 = (self__.level + (1));
while(true){
if((i_13699 <= (new_level + (1)))){
(update[i_13699] = self__.header);

var G__13700 = (i_13699 + (1));
i_13699 = G__13700;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_13701 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13701[i]));
} else {
x__$2.forward.push((((i < links_13701.length))?(links_13701[i]):null));
}

if((i < links_13701.length)){
(links_13701[i] = x__$2);
} else {
links_13701.push(x__$2);
}
...
var i_13707 = (0);
while(true){
if((i_13707 <= self__.level)){
var links_13708 = (update[i_13707]).forward;
if((x__$1 === (((i_13707 < links_13708.length))?(links_13708[i_13707]):null))){
(links_13708[i_13707] = (x__$1.forward[i_13707]));

var G__13714 = (i_13707 + (1));
i_13707 = G__13714;
continue;
} else {
var G__13715 = (i_13707 + (1));
i_13707 = G__13715;
continue;
}
} else {
