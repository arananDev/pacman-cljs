...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11251 = (function (port,fn1_handler){
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11259 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11259(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11263 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11263(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11264 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11264(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_11265 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_11265(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_11269 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_11269(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_11304 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_11304(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11306 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11306(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_11308 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_11308(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11311 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11311(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11317 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11317(b);
}
});
