...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13916 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13916(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13917 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13917(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13918 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13918(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13919 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13919(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13922 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13922(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13925 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13925(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13907,callback){
var map__13908 = p__13907;
var map__13908__$1 = cljs.core.__destructure_map(map__13908);
var input = map__13908__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13908__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13908__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
